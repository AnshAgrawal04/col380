...
def test_all():
    ...
    if result:
        print("Test Case 1 passed " , time_duration)
    else:
        print("Test Case 1 failed " , time_duration)
    
    # test case 2
    result, time_duration = execute_test_case(1, 100, 100, 100, "./input_path/", "./output_path/")
    if result:
        print("Test Case 2 passed " , time_duration)
    else:   
        print("Test Case 2 failed " , time_duration)
    
    # test case 3
    result, time_duration = execute_test_case(2, 100, 100, 100, "./input_path/", "./output_path/")
    if result:  
        print("Test Case 3 passed " , time_duration)
    else:

        print("Test Case 3 failed " , time_duration)

    # test case 4
    result, time_duration = execute_test_case(3, 100, 100, 100, "./input_path/", "./output_path/")
    if result:
        print("Test Case 4 passed " , time_duration)
    else:   
        print("Test Case 4 failed " , time_duration)

    # test case 5
    result, time_duration = execute_test_case(4, 100, 100, 100, "./input_path/", "./output_path/")
    if result:
        print("Test Case 5 passed " , time_duration)
    else:
        print("Test Case 5 failed " , time_duration)

    # test case 6
    result, time_duration = execute_test_case(5, 100, 100, 100, "./input_path/", "./output_path/")
    if result:
        print("Test Case 6 passed " , time_duration)
    else:
        print("Test Case 6 failed " , time_duration)
